...
return [
    'back_link' => 'Volver a AventuraBike',
    'title' => 'Alquiler de Bicicletas Aventura Bike',
    'subtitle' => 'Aventura Bike Bicycle Rental',
    'form_intro' => 'Para continuar con la reserva, rellena el formulario con el día de inicio, día de fin, modelo y talla de la bicicleta que deseas alquilar.',
    'important' => 'Importante',
    'saturday_hours' => 'Los sábados abrimos solo hasta el mediodía',
    'sunday_closed' => 'Domingos cerrado',
    'pickup_option' => 'Existe la posibilidad de recoger la bicicleta el día anterior si el inicio es en domingo.',
    ...
    'dni' => 'DNI',
    'address' => 'Dirección',
    'dni_images' => 'Imágenes del DNI (puedes subir varias)',
    'dni_images_hint' => 'Puedes subir varias fotos (anverso y reverso). Solo se permiten imágenes (JPG, PNG, JPEG). Tamaño máximo: 5 MB cada una.',
    'notes' => 'Observaciones',
    'bicycles_to_rent' => 'Bicicletas a alquilar',

    // Campos de bicicletas
    'size' => 'Talla',
    ...
    'add_bike' => 'Añadir otra bicicleta',

    // Condiciones
    'toggle_terms' => 'Ver / Ocultar Condiciones Generales del Alquiler',
    'accept_terms' => 'He leído y acepto las Condiciones Generales del Alquiler.',
    'general_terms_text' => '
    ...
    'size' => 'Talla',
    'price' => 'Precio',
    'availability_note' => 'Las bicicletas se darán dependiendo de la disponibilidad. En caso de no tener el modelo específico, se proporcionará otro modelo equivalente.',
    'stock_notice' => 'En caso de problemas de stock o disponibilidad, nos pondremos en contacto contigo lo antes posible.',
