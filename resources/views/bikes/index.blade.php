...
<div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-8">
    ...
    <div class="flex justify-end mb-4">
        <a href="{{ route('bikes.create') }}" class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">
            + Nueva Bicicleta
        </a>
    </div>
            ...
            <tbody class="divide-y divide-gray-300">
                @foreach ($bikes as $bike)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="py-2 px-4">{{ $bike->user->name }}</td>
                        ...
                        <td class="py-2 px-4 text-center">
                            <a href="{{ route('bikes.revisions.index', $bike->id) }}" 
                               class="px-3 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600">Revisiones</a>
