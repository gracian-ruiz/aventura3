...
<div class="w-full px-4 sm:px-6 lg:px-10 mt-8">
    <h1 class="app-title text-center mb-6">Listado de Alquileres</h1>
    ...
    <div class="app-toolbar">
        <form method="GET" action="{{ route('alquileres.index') }}" class="mb-2">
        ...
        <div class="text-sm text-slate-600">
            Mostrando {{ $alquileres->count() }} de {{ $alquileres->total() }} alquileres
        </div>
    </div>
