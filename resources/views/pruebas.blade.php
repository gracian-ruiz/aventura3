...
<div class="portada-invitacion __className_f98ef7 oculta" id="portadaInvitacion" style="margin-bottom: 0px!important">
  ...
  <div class="texto-inferior" style="width: 390px;height: 84px">
    <p style="margin-left: -24px;" class="adios fadee-out  fecha">— 18.10.2025 —</p>
  </div>
</div>
...
<div class="fade-in portada" style="height: 770px">
  <div class="fade-in portada-contenido">
    ...
    padding-bottom: 50px;padding-top: 20px;" class="imagen-base" src="{{ asset('images/boda/anillo2.jpeg') }}" alt="foto pareja">
tan especial
...
<div class="section-container fade-in negro" style="margin-top: 30px;">
  ...
  <section class="contenido" style="  background-color: #9aa5a5;padding:5px">
    <div style="padding: 0 1rem; max-width: 800px; margin: 0 auto; font-size: 1.8em;">
